...
Plus opencode's built-in tools (Read, Glob, Grep) for codebase exploration.
...
- **opencode:** verify the Oplane MCP server in your opencode config (see https://opencode.ai/docs/mcp-servers/)
